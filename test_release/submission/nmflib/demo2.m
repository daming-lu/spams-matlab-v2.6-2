...
[d,sr] = audioread('data/example.wav');
...
[W,H,err] = nmf_alg(V, 10, 'alg', @nmf_kl_con, 'niter', 50, 'verb', 2,'win',2);
...
figure; imagesc(W(:,:,1)); axis xy; xlabel('Component'); ylabel('Frequency');
figure; imagesc(W(:,:,1)); axis xy; xlabel('Component'); ylabel('Frequency');
figure; imagesc(H); axis xy; xlabel('Time'); ylabel('Component');
figure; imagesc(V); axis xy; xlabel('Time'); ylabel('Component');
